...
Route::post('/form/submit', 'FormController@store');
    ...
    // why study ahic functions.
    Route::get('study-ahic', 'AhicStudyController@index');
    Route::get('study-ahic/{id}', 'AhicStudyController@show');
    Route::post('study-ahic', 'AhicStudyController@store');
    Route::post('study-ahic/edit', 'AhicStudyController@edit');
    Route::post('study-ahic/update', 'AhicStudyController@update');
    Route::delete('study-ahic/{id}', 'AhicStudyController@destroy');
    ...
    Route::get('get-all-categories-with-courses','CourseCategoryController@getCourseCategoryAndCourses');
    ...
    Route::post('agent/updateStatus/{id}','AgentInformationController@updateStatus');
    Route::get('agent_request_informations','AgentInformationController@agent_requests');
