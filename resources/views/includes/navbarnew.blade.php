            ...
            <div class="collapse navbar-collapse when-collapsed" id="ec-nav__collapsible">
                <ul class="nav navbar-nav ec-nav__navbar ml-auto theme-nav">
                    ...
                    <li class="nav-item nav-item__has-dropdown">
                        <a href="{{url('/')}}/{{$menu['parent_page']['slug']}}" class="nav-link text-capitalize dropdown-toggle course_dropdown <?= ((\Request::segment(1) == $menu['parent_page']['slug'])?'active': ''); ?>" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                            {{$menu['name']}}
                            <!-- {{ \Request::segment(1) }} -->
