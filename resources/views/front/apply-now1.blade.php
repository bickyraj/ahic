...
<section class="paddingBottom-100">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form id="admissionForm" class="admissionForm">
                    <div class="row" style="border: none;">
                        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
                            <div class="row" style="border-radius: 20px; margin-bottom: 30px; border: 1px solid #929292;">
                                <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 form-block-title">
                                    <h5 class="">Course And Date Commencement</h5>
                                </div>
                                <div class="form-group col-md-12">
                                    <label> Choose A Year</label>
                                    <select name="intake_year" id="intake_year" class="form-control form-control-sm">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="intake_date" id="intake_date" class="form-control form-control-sm">
                        ...
                        <div class="col-lg-5 col-sm-5 col-md-5 col-xs-12">
                            ...
                            <div class="row" style="border-radius: 20px; margin-bottom: 30px; border: 1px solid #929292;">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="company_id" id="" class="form-control form-control-sm">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="familyname" value="">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-3">
                                    <label>DOB</label>
                                    <input type="text" name="dob" value="" class="form-control form-control-sm datepicker">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Gender</label>
                                    <input type="text" name="gender" class="form-control form-control-sm" value="">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Place Of Birth City </label>
                                    <input type="text" name="birth_city" class="form-control form-control-sm" value="">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Country </label>
                                    <input type="text" name="birth_country" class="form-control form-control-sm" value="">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Nationality </label>
                                    <input type="text" name="nationality" class="form-control form-control-sm" value="">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Passport Number </label>
                                    <input type="text" name="passport_number" class="form-control form-control-sm" value="">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Issued Date </label>
                                    <input type="text" name="p_issued_date" value="" class="form-control form-control-sm datepicker">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Expired Date </label>
                                    <input type="text" name="p_expired_date" value="" class="form-control form-control-sm datepicker">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Place Of Issue </label>
                                    <input type="text" name="place_of_issue" class="form-control form-control-sm" value="">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Unique Stident Identifier (USI Number) </label>
                                    <input type="text" name="usi_number" class="form-control form-control-sm" value="">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="v_category" value="">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Visa Expired Date</label>
                                    <input type="text" name="v_exp_date" class="form-control form-control-sm datepicker" value="">
                                    <span class="error"></span>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>At which office are you going to apply ur visa</label>
                                    <input type="text" name="v_office" class="form-control form-control-sm" value="">
                                    <span class="error"></span>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control form-control-sm" name="aus_street" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> City/Town </label>
                            <input type="text" class="form-control form-control-sm" name="aus_city" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Province/State</label>
                            <input type="text" class="form-control form-control-sm" name="aus_province" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Post Code </label>
                            <input type="text" class="form-control form-control-sm" name="aus_postcode" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Email </label>
                            <input type="text" class="form-control form-control-sm" name="aus_email" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Country </label>
                            <input type="text" class="form-control form-control-sm" name="aus_country" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Telephone</label>
                            <input type="text" class="form-control form-control-sm" name="aus_telephone" value="">
                            <span class="error"></span>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            <label> Number And Street </label>
                            <input type="text" class="form-control form-control-sm" name="home_street" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> City/Town </label>
                            <input type="text" class="form-control form-control-sm" name="home_city" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Province/State</label>
                            <input type="text" class="form-control form-control-sm" name="home_province" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Email</label>
                            <input type="text" class="form-control form-control-sm" name="home_email" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Post Code </label>
                            <input type="text" class="form-control form-control-sm" name="home_postcode" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Country </label>
                            <input type="text" class="form-control form-control-sm" name="home_country" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Telephone</label>
                            <input type="text" class="form-control form-control-sm" name="home_telephone" value="">
                            <span class="error"></span>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            <label> Name</label>
                            <input type="text" class="form-control form-control-sm" name="e_name" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Relationship</label>
                            <input type="text" class="form-control form-control-sm" name="e_relationship" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Address</label>
                            <input type="text" class="form-control form-control-sm" name="e_address" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Telephone</label>
                            <input type="text" class="form-control form-control-sm" name="e_telephone" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Mobile</label>
                            <input type="text" class="form-control form-control-sm" name="e_mobile" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Email</label>
                            <input type="text" class="form-control form-control-sm" name="e_email" value="">
                            <span class="error"></span>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12 form-block-title">
                            <h5 class="">Educational Qualifications <small> </h5>
                            <button class="btn float-right apply-now-add-btn add_edu_qua" type="button" style="background-color: #2c5397; margin-top: 15px; border-radius: 5px;"><i class="fa fa-plus"></i> Add</button> </small>
                        </div>
                                ...
                                <div class="col-md-12 qua" id="">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="edu[1][qualification]" value="">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label> Educational Institution</label>
                                            <input type="text" class="form-control form-control-sm" name="edu[1][institution]" value="">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label> Started Month</label>
                                            <input type="text" class="form-control form-control-sm" name="edu[1][started_month]" value="">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label> Started Year</label>
                                            <input type="text" class="form-control form-control-sm" name="edu[1][started_year]" value="">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label> Completed Month</label>
                                            <input type="text" class="form-control form-control-sm" name="edu[1][completed_month]" value="">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label> Completed Year</label>
                                            <input type="text" class="form-control form-control-sm" name="edu[1][completed_year]" value="">
                                        </div>
                                    </div>
                                    <hr>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="number" class="form-control form-control-sm" name="score_achieved" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Year Taken</label>
                            <input type="number" name="year_taken" placeholder="eg:2012" class="form-control form-control-sm" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Listening</label>
                            <input type="number" class="form-control form-control-sm" name="listening" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Reading</label>
                            <input type="number" class="form-control form-control-sm" name="reading" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Writing</label>
                            <input type="number" class="form-control form-control-sm" name="writing" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Speaking</label>
                            <input type="number" class="form-control form-control-sm" name="speaking" value="">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Total Score</label>
                            <input type="number" class="form-control form-control-sm" name="total_score" value="">
                            <span class="error"></span>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" value="" class="form-control form-control-sm" name="application_fee">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Tution Fee </label> <br>
                            <input type="text" value="" class="form-control form-control-sm" name="tution_fee">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Overseas Student Health Cover </label> <br>
                            <input type="text" value="" class="form-control form-control-sm" name="health_fee">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Airport Pickup Fee (Optional) </label> <br>
                            <input type="text" value="" class="form-control form-control-sm" name="airport_fee">
                            <span class="error"></span>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div id="if_acco">
                                ...
                                <input type="text" class="form-control form-control-sm" name="if_acco">
                            </div>
                        </div>
                        <div class="form-group col-md-3">
                            <label> Accommodation Start Date </label>
                            <input type="text" name="acco_start_date" value="" class="form-control form-control-sm datepicker">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-3">
                            ...
                            <div class="" id="if_disability">
                                <label>If Yes </label>
                                <input type="text" class="form-control form-control-sm" name="if_disability">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row" style="margin-bottom: 20px;">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="parent_name" value="" class="form-control form-control-sm">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-6">
                            <label> Contact Detail</label> <br>
                            <input type="text" name="contact_detail" value="" class="form-control form-control-sm">
                            <span class="error"></span>
                        </div>
                        <div class="form-group col-md-6">
                            <label> Date</label> <br>
                            <input type="text" name="date" value="" class="form-control form-control-sm datepicker">
                            <span class="error"></span>
                        </div>
                    </div>
                    <hr>
        ...
        $.ajax({
            ...
            error: function(data, textStatus, errorThrown) {
                ...
                $.each(errors, function(key, valueObj) {
                    while (count < 1) {
                        console.log(key);
                        let s = $('input[name=' + key + ']');
                        if (s.length == 0) {
                            s = $('select[name=' + key + ']');
                        }
                        var scrollDiv = s[0].focus();
                        count++;
                    }
