          ...
          <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
              <ul class="nav flex-column mb-3 justify-content-center bg-light-v2" role="tablist">
                  ...
                  <li class="nav-item category-nav-item">
                      <a class="nav-link border rounded text-center @if ($subpage == $mod->module->title) active @endif " data-toggle="tab" href="#Tabs_99-1{{$count}}" role="tab" aria-selected="true">
                          {{$mod->module->title}}
                      </a>
                  </li>
                  @php
            ...
            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                <div class="card p-4 shadow-v3">
                    ...
                    <div class="tab-content">
                        ...
                        @endphp
                        @foreach ($modules as $mod)
                        <div class="tab-pane fade show  @if ($subpage == $mod->module->title) active @endif " id="Tabs_99-1{{$count}}" role="tabpanel">
                            <div class="row">
                                <div class="col-md-12 my-2">
                                    <div id="accordion-4" class="accordion-style-4">
                                        @foreach ($mod->module->content as $content)
                                        <div class="accordion-item mb-3">
                                            <div class="accordion__title h6 border p-3 mb-0" data-toggle="collapse" @if ($count==0) aria-expanded="true" @endif>
                                                {{$content->title}}
                                            </div>
