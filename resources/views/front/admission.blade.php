            ...
            <?php /*
              ...
              */ ?>
              @php
                  ...
                  <li class="nav-item category-nav-item">
                    <?php 
                      if ($mod->module->title == 'Apply Now'){ ?>
                        <a class="nav-link border rounded text-center @if ($count == 0) active @endif " data-toggle="tab" href="apply-now" role="tab" aria-selected="true">
                    <?php }else{ ?>
                        <a class="nav-link border rounded text-center @if ($count == 0) active @endif " data-toggle="tab" href="#Tabs_4-{{$mod->module->id}}" role="tab" aria-selected="true">
                    <?php } ?>
                          {{$mod->module->title}}
                      </a>
                  </li>
      ...
      <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
       <!-- <ul class="nav tab-line tab-line tab-line--3x border-bottom mb-4" role="tablist">
        ...
        <div class="tab-content">
          <div class="tab-pane fade show active" id="Tabs_4-24" role="tabpanel">
            <div class="row">
              <div class="col-12">
          ...
          <div class="tab-pane fade" id="Tabs_4-6" role="tabpanel">
            <div class="col-12">
...
@if($mod['module']['display_type'] != 2 && $mod['module']['title'] != "Orientation")
          ...
          <div class="tab-pane fade" id="Tabs_4-25" role="tabpanel">
          ...
          <div class="tab-pane fade" id="Tabs_4-21" role="tabpanel">
            @foreach ($modules as $mod)
