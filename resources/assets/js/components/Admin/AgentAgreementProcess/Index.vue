          ...
          <div class="card-title">
              ...
              <b-modal class="ess-modal" ref="myModalRef" hide-footer title="Add Course">
                <form @submit.prevent="addCourse" ref="addCourseForm">
                  <div class="form-group">
                    ...
                    <input type="text" name="sent_date" class="form-control" placeholder="" required>
                  </div>
                  <div class="form-group">
                    <label for="">Agreement </label>
                    <input type="file" name="agreement" class="form-control" placeholder="" required>
                  </div>
                  <div class="form-group">
                    <label for="">Received Date </label>
                    <input type="file" name="received_date" class="form-control" placeholder="" required>
                  </div>
                  <div class="form-group">
            ...
            <tbody v-if="table_items.length > 0" v-show="!loading">
              <tr v-for="(menu, index) in table_items" :key="menu.id">
                <td>{{ menu.sent_date}}</td>
                <td>{{ menu.agreement}}</td>
                <td>{{ menu.recieved_date}}</td>
                <td>{{ menu.signed}}</td>
                <td>
