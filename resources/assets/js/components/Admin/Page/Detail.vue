...
<div class="col-md-12">
   <div class="card-title">
            <div class="caption">
               <h5 v-b-toggle.collapse1><i class="fas fa-key"></i>  Page Modules <small class="float-right"> <button class="btn btn-success" @click="showModuleModal"> Add </button> </small></h5>
            </div>
