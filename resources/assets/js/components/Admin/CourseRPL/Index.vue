      ...
      <b-col>
        <b-card class="mb-2 trump-card">
          <div class="card-title">
            <div class="caption">
              <h5><i class="fas fa-key"></i> Course RPL </h5>
            </div>
            <div class="caption card-title-actions">
              <b-button @click="showModal" variant="primary" class="btn btn-sm green pull-right">Add New Course RPL</b-button>
              <b-modal class="ess-modal" ref="myModalRef" hide-footer title="Add Course RPL">
                <form @submit.prevent="addCourserpl" ref="addCourseOutcomeForm">
                  ...
                  <b-btn class="mt-3 pull-right" variant="primary" type="submit">Create Course RPL</b-btn>
  ...
  export default {
    ...
    methods: {
      info(menu, index, button) {
        ...
        axios.get(url + menu.id).then(function(response) {
            ...
            if (response.status === 200 || response.status === 201) {
              ...
              self.modalInfo.title = `Edit Course RPL`
      ...
      editMenu: function() {
        ...
        let url = self.$root.baseUrl + '/api/admin/course_rpl/edit';
          ...
          console.log(response);
           ...
           self.table_items = response.data.data
              ...
              self.$swal({
                // position: 'top-end',
                type: 'success',
                title: 'Course RPL updated successfully.',
      ...
      fetchRPL() {
        let vm = this;
        let self = this;
        let url = self.$root.baseUrl + '/api/admin/course_rpls';
        axios.get(url)
