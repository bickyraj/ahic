...
class ApplicationFormController extends Controller
{
    ...
    public function fetch($id){
            $application = ApplicationForm::find($id)->with('edu','date_of_intake','fee','services','course','passport','aus','home','econtact','english','rpl','services','checklist','underage')->first();
